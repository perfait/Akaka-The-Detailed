...
if ($backups->is_disabled()) {
	...
	$confirm = esc_html__(
		'IMPORTANT: Installing this demo will delete all existing data and contents of your website, so use it only in fresh website. Do you want to continue?', 'fw' //@tact-update
	);
}
?>
...
<h1 class="wp-heading-inline icon-left"><?php esc_html_e('Demo Content Install', 'fw') ?></h1>

<?php echo apply_filters( 'rainbowit_demo_installer_warning_info', '' );//@tact-update ?>
