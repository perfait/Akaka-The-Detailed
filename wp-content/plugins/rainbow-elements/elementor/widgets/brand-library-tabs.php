...
class Rb_Brand_library_tabs extends Widget_Base
{

    public function get_name()
    {
        return 'rb-library-brand-tab';
    }

    public function get_title()
    {
        return __('Brand Library Tabs', 'rainbow-elements');
    }
                        ...
                        <div class="position-sticky clients-wrapper sticky-top rbt-sticky-top-adjust">
                            <ul class="nav tab-navigation-button flex-column nav-pills me-3" id="v-pills-tab"
                                ...
                                foreach ($settings['library_tab_items'] as $library_tab_item):
                                    ...
                                    $tabpanel = $i == 1 ? 'active show' : null;
                                    ?>
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo esc_attr($has_active); ?>  "
                                           id="v-pills-<?php echo esc_attr($i); ?>-tab" data-toggle="tab"
                                           href="#v-pills-<?php echo esc_attr($i); ?>" role="tab"
                                           aria-selected="true"><?php echo wp_kses_post($tab_nav); ?></a>
                                    </li>
                                <?php endforeach; ?>
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                ...
                                foreach ($settings['library_tab_items'] as $elementor_library):
                                    ...
                                    <div class="tab-pane fade  <?php echo esc_attr($tabpanel); ?>"
                                         id="v-pills-<?php echo esc_attr($j); ?>" role="tabpanel"
                                         aria-labelledby="v-pills-<?php echo esc_attr($j); ?>-tab">
