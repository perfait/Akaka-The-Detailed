...
$thumb_size = 'rainbow-thumbnail-sm';
...
$i = 1;   
$btn = $attr = '';
if ( !empty( $settings['modal_button_url']['url'] ) ) {
    $attr  = 'href="' . $settings['modal_button_url']['url'] . '"';
    $attr .= !empty( $settings['modal_button_url']['is_external'] ) ? ' target="_blank"' : '';
    $attr .= !empty( $settings['modal_button_url']['nofollow'] ) ? ' rel="nofollow"' : '';
    $vpbtn = '<a class="rn-btn" ' . $attr . '> <span>' . $settings['modal_button_txt'] . '</span>  <i class="feather-arrow-right-circle"></i></a>';

}else{

    $vpbtn = '<a  href="'. get_the_permalink() .'"  class="rn-btn"> <span>' . $settings['modal_button_txt'] . '</span>  <i class="feather-arrow-right-circle"></i></a>';
}
?>
	...
	<div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true" class="portfolio-wrapper portfolio-slick-activation slick-arrow-style-one rn-slick-dot-style">
               ...
               $preview_type_class = ($preview_type) ? "preview-type-$preview_type" : false;
                ?>  
                <div class="rn-portfolio-slick <?php echo esc_attr($preview_type_class); ?>">
